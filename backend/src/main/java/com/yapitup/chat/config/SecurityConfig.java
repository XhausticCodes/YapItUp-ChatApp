...
/**
 * Security configuration for the application Now with JWT authentication
 */
@Configuration
@EnableWebSecurity
public class SecurityConfig {
    ...
    /**
     * Security filter chain - configures which endpoints are public/private
     */
    @Bean
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow both Vite (5173) and Create React App (3000) ports
        configuration.setAllowedOrigins(Arrays.asList(
                "http://localhost:3000",
                "http://localhost:5173" // Add Vite port
        ));
